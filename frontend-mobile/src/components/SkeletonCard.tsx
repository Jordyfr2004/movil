  ...
  return (
    ...
    >
      ...
      <View style={styles.content}>
        <View style={[styles.block, styles.title, { backgroundColor: theme.skeletonBase }]} />
        <View style={[styles.block, styles.line, { backgroundColor: theme.skeletonBase }]} />
        <View style={[styles.block, styles.shortLine, { backgroundColor: theme.skeletonBase }]} />
      </View>
    </Animated.View>
  );
}
